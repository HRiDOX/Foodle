...
DEBUG = config('DEBUG' , cast=bool) #as it always return string values but it has to be a boolean value that's we need to cast it's type
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'marketplace.context_processors.get_cart_ammounts'
            ],
        },
    },
]
